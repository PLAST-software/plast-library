...
/** \file SmallGapHitIteratorSIMD.hpp
 *  \brief Implementation of IHitIterator interface for small gap alignments.
 *  \date 07/11/2011
 *  \author edrezen
 */

#ifndef _SMALLGAP_HIT_ITERATOR_SIMD_HPP_
#define _SMALLGAP_HIT_ITERATOR_SIMD_HPP_
 ...
 */
class SmallGapHitIteratorSIMD : public algo::hits::common::AbstractPipeHitIterator
{
public:

    /** \copydoc common::AbstractPipeHitIterator::AbstractPipeHitIterator */
    SmallGapHitIteratorSIMD (
    ...
    /** Destructor. */
    virtual ~SmallGapHitIteratorSIMD ();

    /** \copydoc common::AbstractPipeHitIterator::getName */
    const char* getName ()  { return "SmallGapHitIteratorSIMD"; }
...
protected:
    ...
    {
        return new SmallGapHitIteratorSIMD (sourceIterator, _model, _scoreMatrix, _parameters, _ungapResult, _alignmentResult);
    }
    ...
    misc::Vector<int32_t> _computedScores;
    int32_t* getComputedScores (size_t n);
...
#endif /* _SMALLGAP_HIT_ITERATOR_SIMD_HPP_ */
