...
public:
    ...
    static const char* m_STR_OPTION_LOGGER () { return "-logger"; }
    ...
    static const char* m_STR_HELP_LOGGER () { return "Intialize a logger. Argument is one of DEBUG, INFO or ERROR. Log traces are appended in plast.log file; file is created if necessary."; }
