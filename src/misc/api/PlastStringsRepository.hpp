...
public:
    ...
    static const char* m_STR_OPTION_CREATE_SEEDS_MASK_FOR_CLOSE_HOMOLOGS () { return "-C"; }
    ...
    static const char* m_STR_HELP_CREATE_SEEDS_MASK_FOR_CLOSE_HOMOLOGS () { return "Useful option to optimize close homologs comparison"; }
    ...
    static const char* m_STR_PARAM_wordSize () { return "wordSize"; }
    static const char* m_STR_PARAM_maskForCloseHomologs () {return "maskForCloseHomologs";}
};
